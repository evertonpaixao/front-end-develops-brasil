...
function fecharPopup() {
  ...
  function pesquisar() {
    ...
    for (let dado of dados) {
      ...
      if (dado.titulo.toLowerCase().includes(campoPesquisa) || dado.conhecimentos.toLowerCase().includes(campoPesquisa) || dado.tags.some(tag => tag.toLowerCase().includes(campoPesquisa.toLowerCase()))) {
        ...
        resultados += `
          <div class="item-resultado">
            <div class="texto-item">
              ...
              <p>
                <a href="${dado.link}" target="_blank">Ver portfólio</a>
              </p>
            </div>
    ...
    const resultadoAleatorio = `
        <div class="item-resultado">
          <div class="texto-item">
            ...
            <p class="conhecimentos-meta">
              ${dados[indiceAleatorio].conhecimentos}
            </p>
            <p>
              <a href="${dados[indiceAleatorio].link}" target="_blank">Acessar portfólio</a>
            </p>
          </div>
          <div class="imagem-item">
